...
def recognize(image_path, weights_path, char_dict_path, txt_path):
    ...
    inputdata = tf.placeholder(dtype=tf.float32, shape=[1, CFG.ARCH.INPUT_SIZE[1], None, CFG.ARCH.INPUT_CHANNELS],
                               # 宽度可变
                               name='input')
    ...
    with sess.as_default():
        ...
        for image_name in image_names:
            ...
            # print('Predict image {:s}  total time:{:f}  pre_process time:{:f}, run time:{:f},  convert_time:{:f}'\
            # .format(preds[0], time_end_3 - time_start, time_end_1 - time_start, time_end_2 - time_end_1, \
            # time_end_3 - time_end_2))
